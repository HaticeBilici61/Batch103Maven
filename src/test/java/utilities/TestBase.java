...
//    Amacim bu sinifi extend etmek ve icindeki hazir metodlari kullanma
    ...
    public void setUp() {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(15));//maximum bu saniye kadar bekle,selnium dan gelir
    ...
    /*   HARD WAIT:Thread.sleep ...icine yaziulan surenin sonuna kadar bekler,java dan gelir
  @param : second
*/
...
//    Bu method ile sayfanin en altina inebiliriz
 ...
 //   Bu metot ile belirli bir elemente JS executor ile tiklanabilir
    ...
    //SENDKEYS GIBI SETATRIBUTE ILE YAZI YAZDIRMA
...
//            */
    //EROL HOCA TEST BASE SETUP ADIYLA OLUSTIRDU BEN EXTENTREPORT OLARAK DEGISTIRDIM
    ExtentReports extentReports;//Raporlamayı başlatırız
    ExtentHtmlReporter extentHtmlReporter;//Raporumu HTLM formatında düzenler
    ...
    public void extendReports() {
        ...
        String tarih = new SimpleDateFormat("hh_mm_ss_ddMMyyyy").format(new org.apache.poi.hpsf.Date());
