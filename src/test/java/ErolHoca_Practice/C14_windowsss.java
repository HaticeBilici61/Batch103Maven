...
public class C14_windowsss extends TestBase {
    ...
    public void test01(){
        ...
        WebElement texbox= driver.findElement(By.xpath("//p[text()='Your content goes here.']"));
        texbox.clear();
        texbox.sendKeys("Techproeducation");

        // TextBox’in altinda bulunan “Elemental Selenium” linkinin gorunur oldugunu test edin
        driver.switchTo().defaultContent();
        String yazi=  driver.findElement(By.xpath("//a[text()='Elemental Selenium']")).getText();
        String expectedyazi="Elemental Selenium";
        Assert.assertTrue(yazi.contains(expectedyazi));
       // Assert.assertTrue( driver.findElement(By.xpath("//a[text()='Elemental Selenium']")).isDisplayed());..bu sekilde de yazabilriz
